...
.table-fixed tbody { height: 400px!important;}
 ...
 <body>
	...
	<h1 style="text-align:center;float:left;width:100%; margin:-10px 0 5px">Scheduled Scrap & Results</h1>
	<div class="scr1" style="height:auto;">
		<table class="table table-fixed" style="margin:0;">
		<thead>
		<tr style="background:#337ab7!important;">
		<th class="col-sm-2">Scrap Name</th>
		<th class="col-sm-2">Last Scrap Date</th>
		<th class="col-sm-2">Scheduled Scrap Date</th>
		...
		<td class="col-sm-4"><a href="lead_viewschedule.php?view=<?php echo $val['id']; ?>">View</a> | <a onclick="return deleteschedule(<?php echo $val['id']; ?>);" href="#">Delete</a> | <a onclick="return exportschedule(<?php echo $val['id']; ?>);" href="#">Export</a> | <a href="lead_schedulesearch.php?schid=<?php echo $val['id']; ?>">Reschedule Scrap </a></td>
		   </tr>
		<?php } ?>
	</table>
	</div>
