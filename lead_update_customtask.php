  ...
  <div style="width:100%; float:left; margin:0;"><?php  include('nav.php'); ?></div>
    <div class="scr1" style="height:auto;">
      ...
      <form id="cdsearchform" method="post" >
        <div class="mt-3 mb-3 d-flex flex-wrap editform">
          <div class="col-sm-4">
          ...
          <div class="col-sm-4">
            <p class="heading2">Contact Information</p>
            <p><label><span>Phone 1</span></label><br/> <input type="text" class="edittext" name="phone1" id="phone1" value="<?php echo  isset($propertdata['phone1']) ? $propertdata['phone1'] : '' ?>"></p>

            <p><label><span>Phone 2</span></label><br/> <input type="text" class="edittext" name="phone2" id="phone2" value="<?php echo  isset($propertdata['phone2']) ? $propertdata['phone2'] : '' ?>"></p>

            <p><label><span>Email 1</span></label><br/> <input type="text" class="edittext" name="email1" id="email1" value="<?php echo  isset($propertdata['email1']) ? $propertdata['email1'] : '' ?>"></p>

            <p><label><span>Email 2</span></label><br/> <input type="text" class="edittext" name="email2" id="email2" value="<?php echo  isset($propertdata['email2']) ? $propertdata['email2'] : '' ?>"></p>
          </div>
