...
function getscheduledetailid($vewid){
    ...
    $db->select('scheduled_batch', array('id'=>$vewid),'' , 'id DESC','*');
...
<style>
.active4{background:#337ab7!important;}
...
body{overflow-x:hidden}
 ...
 <div style="width:100%; float:left; margin:0;"><?php  include('nav.php'); ?></div>
    ...
    <table class="table table-fixed" style="margin:0;">
		...
		<tr>
		<td style="text-align:center;" class="lf0"><!--<input type="checkbox" class="apncheck chk"  value="<?php echo $val['parcel_number']; ?>" style="width:15px; height:15px; top:1px; position:relative;" />--> <?php echo $i; ?>.</td>
