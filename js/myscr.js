  ...
  $("#filtername").on('input', function() {
    ...
    if ($('#datalistname').find('option').filter(function() {
      ...
      jQuery.ajax({
        ...
        success: function(data) {
          console.log(data);
          $('#num_units_min').val(data.num_units_min);
          $('#num_units_max').val(data.num_units_max);
          $('#num_bedrooms_min').val(data.num_bedrooms_min);
          $('#num_bedrooms_max').val(data.num_bedrooms_max);
          $('#num_baths_min').val(data.num_baths_min);
          $('#num_baths_max').val(data.num_baths_max);
          $('#num_stories_min').val(data.num_stories_min);
          $('#num_stories_max').val(data.num_stories_max);
          $('#cost_per_sq_ft_min').val(data.cost_per_sq_ft_min);
          $('#cost_per_sq_ft_max').val(data.cost_per_sq_ft_max);
          $('#lot_area_sq_ft_min').val(data.lot_area_sq_ft_min);
          $('#lot_area_sq_ft_max').val(data.lot_area_sq_ft_max);
          $('#sales_price_min').val(data.sales_price_min);
          $('#sales_price_max').val(data.sales_price_max);
          $('#year_built_min').val(data.year_built_min);
          $('#year_built_max').val(data.year_built_max);
          $('#sales_date_from').val(data.sales_date_from);
          $('#sales_date_to').val(data.sales_date_to);
          $('#searchid').val(data.searchid);
          $("input[name=is_owner_occupied][value='" + data.is_owner_occupied + "']").prop("checked", true);
